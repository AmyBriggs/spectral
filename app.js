$(document).ready(function() {
    ...
    var sounds = {
        sound0: new Howl({
            urls: ['sounds/celesta-mp3/C4.mp3'],
        }),
        sound1: new Howl({
            urls: ['sounds/celesta-mp3/C5.mp3']
        }),
        sound2: new Howl({
            urls: ['sounds/celesta-mp3/G5.mp3']
        }),
        sound3: new Howl({
            urls: ['sounds/celesta-mp3/C6.mp3']
        }),
        sound4: new Howl({
            urls: ['sounds/celesta-mp3/E6.mp3']
        }),
        sound5: new Howl({
            urls: ['sounds/celesta-mp3/G6.mp3']
        }),
        sound6: new Howl({
            urls: ['sounds/celesta-mp3/Bb6.mp3']
        }),
        sound7: new Howl({
            urls: ['sounds/celesta-mp3/C7.mp3']
        }),
        sound8: new Howl({
            urls: ['sounds/celesta-mp3/D7.mp3']
        }),
        sound9: new Howl({
            urls: ['sounds/celesta-mp3/E7.mp3']
        }),
        sound10: new Howl({
            urls: ['sounds/celesta-mp3/Gb7.mp3']
        }),
        sound11: new Howl({
            urls: ['sounds/celesta-mp3/Bb7.mp3']
        }),
    }
